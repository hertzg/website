...
function create_page ($mysqli, $user, &$scripts, $base = '') {
    ...
    if ($tag === '') {
        ...
        include_once "$fnsDir/Users/Contacts/indexPage.php";
        $contacts = Users\Contacts\indexPage($mysqli,
        ...
        include_once "$fnsDir/ContactTags/indexPageOnUserTagName.php";
        $contacts = ContactTags\indexPageOnUserTagName($mysqli,
    ...
    render_contacts($contacts, $items, $params, $base);
