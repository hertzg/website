...
$sendExternalFunction = function ($recipients) use (
    ...
    foreach ($recipients as $recipient) {
        Users\Contacts\Sending\add($mysqli, $user, $recipient,
            $contact->full_name, $contact->alias, $contact->address,
            $contact->email1, $contact->email1_label, $contact->email2,
            $contact->email2_label, $contact->phone1, $contact->phone1_label,
            $contact->phone2, $contact->phone2_label, $contact->birthday_time,
