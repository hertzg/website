...
function create ($mysqli, $user, &$scripts) {
    ...
    if ($tag === '') {
        ...
        include_once "$fnsDir/Notes/searchPage.php";
        $notes = \Notes\searchPage($mysqli, $id_users, $includes,
        ...
        include_once "$fnsDir/NoteTags/searchPageOnUserTagName.php";
        $notes = \NoteTags\searchPageOnUserTagName($mysqli, $id_users,
    ...
    renderNotes($notes, $items, $params, $includes);
