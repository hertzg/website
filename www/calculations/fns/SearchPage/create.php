...
function create ($mysqli, $user, &$scripts) {
    ...
    if ($tag === '') {
        ...
        $calculations = \Calculations\searchPage($mysqli,
        ...
        $calculations = \CalculationTags\searchPageOnUserTagName($mysqli,
    ...
    renderCalculations($user, $calculations, $items, $params, $keyword);
