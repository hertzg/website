        ...
        echo
            ...
            .'<html>'
                .'<head>'
                    ...
                    ."<link rel=\"stylesheet\" type=\"text/css\" href=\"{$base}common.css?15\" />"
                    ."<link rel=\"stylesheet\" type=\"text/css\" href=\"{$base}icons.css?3\" />"
                    ."<link rel=\"stylesheet\" type=\"text/css\" href=\"{$base}themes/$theme/common.css?2\" />"
                    .$this->head
                .'</head>'
                ."<body>$body</body>"
            .'</html>';
        ...
        $this->echoHtml(
            '<div id="tbar">'
                .'<div style="position: relative">'
                    ."<a class=\"topLink\" href=\"{$base}home.php\">"
