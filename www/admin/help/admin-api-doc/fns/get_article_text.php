...
function get_article_text () {
    ...
    return
        '<em class="term">Zvini Admin API</em> allows programs to manage'
        .' an instance of Zvini by calling API methods with HTTP.'
        ...
        .' of them from "Administration" &gt; "Admin API Keys" page.'
