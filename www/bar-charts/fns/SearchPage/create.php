...
function create ($mysqli, $user, &$scripts) {
    ...
    if ($tag === '') {
        ...
        $bar_charts = \BarCharts\searchPage($mysqli, $id_users,
        ...
        $bar_charts = \BarChartTags\searchPageOnUserTagName($mysqli, $id_users,
    ...
    renderBarCharts($bar_charts, $items, $params, $includes);
