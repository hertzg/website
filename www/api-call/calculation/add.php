...
require_user_calculation_params($mysqli, $user, $expression, $title, $tags,
    $tag_names, $value, $error, $error_char, $referenced_calculations);
...
$id = Users\Calculations\add($mysqli, $user->id_users,
    ...
    $error_char, $referenced_calculations, $apiKey);
