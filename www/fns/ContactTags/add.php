...
function add ($mysqli, $id_users, $id_contacts, $tag_names,
    ...
    $sql = 'insert into contact_tags'
        .' (id_users, id_contacts, tag_name, full_name, alias,'
        .' phone1, phone2, favorite, insert_time, update_time) values';
    foreach ($tag_names as $i => $tag_name) {
        if ($i) $sql .= ', ';
        $tag_name = $mysqli->real_escape_string($tag_name);
        $sql .= "($id_users, $id_contacts, '$tag_name', '$full_name', '$alias',"
            ." '$phone1', '$phone2', $favorite, $insert_time, $update_time)";
    }
