...
function edit ($mysqli, $id, $title, $expression, $tags, $tag_names,
    $value, $error, $error_char, $referenced, $update_time, $updateApiKey) {
    ...
    $sql = "update calculations set title = '$title',"
        ...
        ." referenced = '$referenced', update_time = $update_time,"
