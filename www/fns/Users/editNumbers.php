...
function editNumbers ($mysqli, $id, $num_api_keys,
    $num_archived_received_bookmarks, $num_archived_received_calculations,
    $num_archived_received_contacts, $num_archived_received_files,
    $num_archived_received_folders, $num_archived_received_notes,
    $num_archived_received_places, $num_archived_received_schedules,
    $num_archived_received_tasks, $num_bar_charts, $num_bookmarks,
    $num_calculations, $num_channels, $num_connections,
    $num_contacts, $num_deleted_items, $num_events, $num_files,
    $num_folders, $num_notes, $num_notifications,
    $num_password_protected_notes, $num_places,
    $num_received_bookmarks, $num_received_calculations,
    ...
    $sql = "update users set num_api_keys = $num_api_keys,"
        ...
        ." num_archived_received_calculations = $num_archived_received_calculations,"
        ...
        ." num_calculations = $num_calculations, num_channels = $num_channels,"
        ...
        ." num_received_calculations = $num_received_calculations,"
