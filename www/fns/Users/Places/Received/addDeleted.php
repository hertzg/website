...
function addDeleted ($mysqli, $receiver_id_users, $data) {
    ...
    \ReceivedPlaces\addDeleted($mysqli, $data->id,
        $data->sender_id_users, $data->sender_username,
        $receiver_id_users, $data->latitude, $data->longitude,
        $data->name, $data->tags, $archived, $data->insert_time);
