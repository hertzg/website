...
function addDeleted ($mysqli, $receiver_id_users, $data) {
    ...
    \ReceivedContacts\addDeleted($mysqli, $data->id, $data->sender_id_users,
        ...
        $data->phone1_label, $data->phone2, $data->phone2_label,
        $data->birthday_time, $data->username, $data->timezone,
        $data->tags, $data->notes, $data->favorite, $archived,
        $data->insert_time, $data->photo_id);
