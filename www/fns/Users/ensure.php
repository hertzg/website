...
function ensure ($mysqli) {
    ...
    return \Table\ensure($mysqli, 'users', [
        ...
        'anonymous_can_send_calculation' => ['type' => 'tinyint(3) unsigned'],
        ...
        'disabled' => ['type' => 'tinyint(3) unsigned'],
        'email' => \Email\column(),
        'email_expire_time' => [
        ...
        'home_num_new_received_calculations' => ['type' => 'bigint(20) unsigned'],
        ...
        'num_archived_received_calculations' => ['type' => 'bigint(20) unsigned'],
        ...
        'num_calculations' => ['type' => 'bigint(20) unsigned'],
        ...
        'num_received_calculations' => ['type' => 'bigint(20) unsigned'],
        ...
        'show_calculations' => ['type' => 'tinyint(3) unsigned'],
        ...
        'show_new_calculation' => ['type' => 'tinyint(3) unsigned'],
