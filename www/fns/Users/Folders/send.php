...
function send ($mysqli, $user, $receiver_id_users, $folder) {
    ...
    $id_received_folders = \ReceivedFolders\add($mysqli, $user->id_users,
    ...
    $copy = function ($id, $parent_id, $copy) use ($mysqli, $id_received_folders) {
        ...
        if ($folders) {
            ...
            foreach ($folders as $folder) {
                $id = \ReceivedFolderSubfolders\add($mysqli,
                    $id_received_folders, $parent_id, $folder->name);
