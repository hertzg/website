...
function addDeleted ($mysqli, $receiver_id_users, $data) {
    ...
    \ReceivedFiles\addDeleted($mysqli, $data->id, $data->sender_id_users,
        $data->sender_username, $receiver_id_users, $data->content_type,
        $data->media_type, $data->name, $data->size, $data->hashes_computed,
        $data->md5_sum, $data->sha256_sum, $archived, $data->insert_time);
