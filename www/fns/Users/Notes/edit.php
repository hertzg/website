...
function edit ($mysqli, $note, $text, $tags, $tag_names,
    $encrypt_in_listings, $password_protect, $updateApiKey = null) {
    ...
    \Notes\edit($mysqli, $id, $text, $title, $tags, $tag_names,
    ...
    if ($tag_names) {
        ...
        \NoteTags\add($mysqli, $note->id_users, $id, $tag_names,
            $text, $title, $tags, $encrypt_in_listings, $password_protect);
    }
