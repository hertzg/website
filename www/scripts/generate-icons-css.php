...
$names = [
    ...
    'subscribed-channel', 'subscribed-channels', 'account', 'edit-profile',
    'contact', 'contacts', 'create-contact', 'edit-contact', 'file', 'files',
    ...
    'import-note', 'import-task', 'search', 'search-folder', 'event',
    'create-event', 'edit-event', 'checkbox', 'checked-checkbox', 'help',
    'token', 'create-token', 'tokens', 'run', 'mail', 'send', 'receive',
