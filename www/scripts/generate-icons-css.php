...
$names = [
    ...
    'subscribed-channel', 'subscribed-channels', 'account',
    ...
    'create-task', 'edit-task', 'download', 'upload', 'send', 'receive',
    'feedback', 'yes', 'no', 'notification', 'old-notification', 'edit-password',
    'new-password', 'reset-password', 'randomize', 'rename', 'sign-out', 'sign-in',
