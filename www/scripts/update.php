...
$mysqli->query('alter table files change file_size size bigint unsigned not null');
$mysqli->query('alter table received_files change file_size size bigint unsigned not null');
