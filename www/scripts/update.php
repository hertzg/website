...
$sql = "select * from deleted_items where data_type = 'note'";
...
foreach ($deleted_items as $deleted_item) {
    ...
    $data->password_protect = false;
    $data->encrypted_text = $data->encrypted_text_iv = null;
    $data->encrypted_title = $data->encrypted_title_iv = null;
    unset($data->encrypt);
...
$sql = "select * from deleted_items where data_type = 'receivedNote'";
include_once '../fns/mysqli_query_object.php';
$deleted_items = mysqli_query_object($mysqli, $sql);
