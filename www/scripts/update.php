...
$sql =
    ...
    .' add can_read_notes tinyint not null after can_read_files,'
    ...
    .' add can_read_tasks tinyint not null after can_read_schedules,'
    ...
    .' add can_write_notes tinyint not null after can_write_files,'
    ...
    .' add can_write_tasks tinyint not null after can_write_schedules';
