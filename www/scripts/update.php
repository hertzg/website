...
$mysqli->query('drop table if exists received_folders') || trigger_error($mysqli->error);
...
$mysqli->query('drop table if exists received_folder_subfolders') || trigger_error($mysqli->error);
...
$mysqli->query('drop table if exists received_folder_files') || trigger_error($mysqli->error);
